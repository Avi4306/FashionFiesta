...
export const START_ADMIN_LOADING = 'START_ADMIN_LOADING';
export const END_ADMIN_LOADING = 'END_ADMIN_LOADING';
...
export const FETCH_DESIGNER_APPLICATIONS = 'FETCH_DESIGNER_APPLICATIONS';
export const APPROVE_DESIGNER_APPLICATION = 'APPROVE_DESIGNER_APPLICATION';
export const REJECT_DESIGNER_APPLICATION = 'REJECT_DESIGNER_APPLICATION';