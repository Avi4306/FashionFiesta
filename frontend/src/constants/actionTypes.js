...
export const VERIFY_ADMIN_USER = 'VERIFY_ADMIN_USER'
...
export const DELETE_ADMIN_DONATION = 'DELETE_ADMIN_DONATION'
export const FETCH_ADMIN_DONATIONS = 'FETCH_ADMIN_DONATIONS'
export const UPDATE_ADMIN_DONATION_STATUS = 'UPDATE_ADMIN_DONATION_STATUS'

export const  SUBMIT_DONATION_REQUEST = 'SUBMIT_DONATION_REQUEST'
export const  SUBMIT_DONATION_SUCCESS = 'SUBMIT_DONATION_SUCCESS'
export const  SUBMIT_DONATION_FAIL = 'SUBMIT_DONATION_FAIL'
export const  CLEAR_DONATION_ERROR = 'CLEAR_DONATION_ERROR'
export const  SUBMIT_DONATION_SUCCESS_RESET = 'SUBMIT_DONATION_SUCCESS_RESET'
export const  FETCH_MY_DONATIONS_REQUEST = 'FETCH_MY_DONATIONS_REQUEST'
export const  FETCH_MY_DONATIONS_SUCCESS = 'FETCH_MY_DONATIONS_SUCCESS'
export const  FETCH_MY_DONATIONS_FAIL = 'FETCH_MY_DONATIONS_FAIL'
...
export const  CLEAR_DONATION_LIST_ERROR = 'CLEAR_DONATION_LIST_ERROR'
...
// Admin Donations List Actions
export const FETCH_ALL_DONATIONS_REQUEST = 'FETCH_ALL_DONATIONS_REQUEST';
export const FETCH_ALL_DONATIONS_SUCCESS = 'FETCH_ALL_DONATIONS_SUCCESS';
export const FETCH_ALL_DONATIONS_FAIL = 'FETCH_ALL_DONATIONS_FAIL';

export const FETCH_OUTFITS = 'FETCH_OUTFITS';
export const FETCH_TOP_OUTFITS = 'FETCH_TOP_OUTFITS';
export const CREATE_OUTFIT = 'CREATE_OUTFIT';
export const LIKE_OUTFIT = 'LIKE_OUTFIT';
export const DELETE_OUTFIT = 'DELETE_OUTFIT';
export const OUTFIT_ERROR = 'OUTFIT_ERROR';
export const OUTFIT_LOADING = 'OUTFIT_LOADING';

export const FETCH_ADMIN_OUTFITS = 'FETCH_ADMIN_OUTFITS';
export const CREATE_ADMIN_OUTFIT = 'CREATE_ADMIN_OUTFIT';
export const DELETE_ADMIN_OUTFIT = 'DELETE_ADMIN_OUTFIT';